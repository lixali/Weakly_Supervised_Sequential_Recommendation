...
relevance_score_file=/data/user_data/lixiangl/fastText/best_model_epoch_6/sorted_pixelrec_only/score_ranking/epoch_6_clueweb400k_relevance_score_pretrain.jsonl
