...
#SBATCH --job-name=SASRec_microlens_25_percent_data
...
checkpoint_dir=/data/user_data/lixiangl/HLLM_2/HLLM/model_SASRec_microlens_baseline_25_percent_data_batchszie_32_x_4_deepspeed_3_epochs_50_April_4_2025/
