...
#SBATCH --job-name=benchmark_HLLM
...
checkpoint_dir="/data/user_data/lixiangl/HLLM_2/HLLM/model_benchmark_batchszie_64_deepspeed_3_Jan_16_2025_need_training_loss_vs_iteration/"
...
pretrain_dir="/data/datasets/hf_cache/sample/TinyLlama-1.1B-intermediate-step-1431k-3T/"
