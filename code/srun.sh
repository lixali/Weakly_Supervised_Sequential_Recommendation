...
checkpoint_dir="/data/user_data/lixiangl/HLLM_2/HLLM/model_clueweb_sbatch_epoch_6_pretrain_script_batchszie_128_deepspeed_3_hllm_filtered/"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 ${file_prefix}/main.py \
    ...
    --loss nce \
    --epochs 5 \
    --dataset epoch_6_clueweb90k_train_hllm_filtered \
    --train_batch_size 32 \
    --MAX_TEXT_LENGTH 256 \
