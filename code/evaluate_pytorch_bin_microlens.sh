...
checkpoint_dir=/data/user_data/lixiangl/HLLM_2/HLLM/model_microlens_continual_pretrain_batchszie_128_deepspeed_3_epochs_5_eval_same_data_further_curate_corpus_25_percent_modal_HLLM_filtered_threhold_0p45_March_20_2025/HLLM-0.pth/pretrained/25_percent_SFT/HLLM-0.pth/
